package com.zhuyaya.platform.common.xss;

import com.zhuyaya.platform.common.utils.JsoupUtil;
...
public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    /**
     * 覆盖getHeader方法，将参数名和参数值都做 xss 过滤
     * 如果需要获得原始的值，则通过super.getHeader(name)来获取
    ...
    public String getParameter(String name) {
        String param1 = "content";
        String param2 = "WithHtml";
        if ((param1.equals(name) || name.endsWith(param2)) && !isIncludeRichText) {
