package com.zhuyaya.platform.monitor.entity;
...
public class Log implements Serializable {
    ...
    private static final long serialVersionUID = -6889291822587197343L;
    ...
    private transient String createTimeForm;
